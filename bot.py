...
try:
    ...
    from b3gate import braintree_auth # Import the Tele function from gatet.py
    import time
except:
    os.system('pip install requests fake_useragent bs4 telebot ')
# Bot configuration
TOKEN = "7655289016:AAFaTQQjul6GlrOrDWFRCgU9Kb3f3vmeg-A"  # Replace with your bot token
OWNER_ID = 5690180919 # Replace with your owner ID
